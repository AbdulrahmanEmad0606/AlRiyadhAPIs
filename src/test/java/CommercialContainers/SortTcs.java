...
public class SortTcs extends RequestSetup {
    ...
    public void checkSortingByEventId() {
        Response response = makeApiCallWithSort(commercialContainersReportsBasePath, "eventNo");
    ...
    public void checkSortingByUnitNameDesc() {
        Response response = makeApiCallWithSort(commercialContainersReportsBasePath, "unit_desc");
        ResponseDataForDashBoard dataTableData = response.as(ResponseDataForDashBoard.class);
        List<ResponseDataForDashBoard.ReportData> list = dataTableData.data.reportData;
        boolean isSorted = true;
        for (int i = 1; i < list.size(); i++) {
    ...
    public void checkSortingByReporterName() {
        Response response = makeApiCallWithSort(commercialContainersReportsBasePath, "reporterName");
        ResponseDataForDashBoard dataTableData = response.as(ResponseDataForDashBoard.class);
        List<ResponseDataForDashBoard.ReportData> list = dataTableData.data.reportData;
    ...
    public void checkSortingBySubmitionDate() {
        Response response = makeApiCallWithSort(commercialContainersReportsBasePath, "submitionDate");
        ResponseDataForDashBoard dataTableData = response.as(ResponseDataForDashBoard.class);
        List<ResponseDataForDashBoard.ReportData> list = dataTableData.data.reportData;
    ...
    public void checkSortingByEventStatusName() {
        Response response = makeApiCallWithSort(commercialContainersReportsBasePath, "eventStatus");
        ResponseDataForDashBoard dataTableData = response.as(ResponseDataForDashBoard.class);
        List<ResponseDataForDashBoard.ReportData> list = dataTableData.data.reportData;
    ...
    public void checkSortingByContainerTypeName() {
        Response response = makeApiCallWithSort(commercialContainersReportsBasePath, "containertype");        ResponseDataForDashBoard dataTableData = response.as(ResponseDataForDashBoard.class);
        List<ResponseDataForDashBoard.ReportData> list = dataTableData.data.reportData;
